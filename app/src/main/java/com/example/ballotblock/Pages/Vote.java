...
//        token copied from console when logging in user from app
//        String accessToken = "access-token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6OSwicm9sZSI6InZvdGVyIiwiaWF0IjoxNjUwMTY0ODI0LCJleHAiOjE2NTAxNzIwMjR9.-f4rHLSDFvn19dAwAW3EwDx2B7JIcXgKVOjJ7Lg19FI";
            ...
            public void onResponse(Call<ArrayList<VoteCandidatesModel>> call, Response<ArrayList<VoteCandidatesModel>> response) {
                if (response.isSuccessful()) {
                    if(response.body().size() > 0) {
                        ...
                        Toast.makeText(Vote.this, "Cannot Show List of Candidates. API Response body is null", Toast.LENGTH_SHORT).show();
                    }
                }
                else {
